...
class JsbsimCatalog(Property, Enum):
    ...
    position_h_sl_ft = Property("position/h-sl-ft", "海拔，高于平均海平面的高度 [ft]", -1400, 85000)
    position_h_agl_ft = Property(
        "position/h-agl-ft", "高于地平面的高度 [ft]", position_h_sl_ft.min, position_h_sl_ft.max
    )
    ...
    aero_alpha_deg = Property("aero/alpha-deg", "迎角", access="R")
    aero_beta_rad = Property("aero/beta-rad", "侧滑角", access="R")
